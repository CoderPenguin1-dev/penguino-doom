...
## Key Features
- "Invulnerability Effect" setting to change how the sky is affected by the Invuln powerup (idea from *[Woof!](https://github.com/fabiangreffrath/woof)*).
- Extended settings for some hud components.
