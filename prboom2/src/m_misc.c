...
cfg_def_t cfg_defs[] =
{
  ...
  MIGRATED_SETTING(dsda_config_hud_animated_count),
  ...
  MIGRATED_SETTING(dsda_config_translucent_effects),
  ...
  SETTING_HEADING("Doom Automap Colors"),
  ...
  SETTING_HEADING("Heretic Automap Colors"),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_back),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_grid),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_wall),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_fchg),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_cchg),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_clsd),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_gkey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_bkey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_ykey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_gdor),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_bdor),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_ydor),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_tele),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_secr),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_revsecr),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_tagfinder),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_exit),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_exitsecr),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_unsn),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_flat),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_sprt),
  ...
  SETTING_HEADING("Hexen Automap Colors"),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_back),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_grid),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_wall),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_fchg),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_cchg),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_clsd),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_key),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_dor),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_puzzle),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_tele),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_tagfinder),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_exit),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_unsn),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_flat),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_sprt),
  ...
  MIGRATED_SETTING(dsda_config_auto_key_frame_active),
  ...
  MIGRATED_SETTING(nyan_config_ex_status_backpack),
  MIGRATED_SETTING(nyan_config_ex_status_radsuit),
